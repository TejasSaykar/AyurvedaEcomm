    ...
    <Layout>
      <div className="bg-white pb-5 pt-10">
        {loading ? (
          ...
          <div className="grid  grid-cols-1 md:gap-4 space-y-4 md:space-y-0 md:grid-cols-3 py-10 px-4 md:w-[80%] mx-auto mb-8 md:mb-0">
            {Array(1, 2, 3, 4)?.map((item) => (
              <Link className="w-full relative animate-pulse h-[300px] -z-9 cursor-pointer flex flex-col gap-2 p-4 bg-gray-300/50 rounded-md">
                {item.quantity == 0 && (
